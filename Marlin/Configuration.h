...
#define STRING_CONFIG_H_AUTHOR "(Geggio, Ender-3 Pro SKR 1.4T)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Printachu"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  33.43
    #define DEFAULT_Ki   4.18
    #define DEFAULT_Kd 66.85
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  120.2
  #define DEFAULT_bedKi   23.21
  #define DEFAULT_bedKd 415.109
...
#define LCD_BED_TRAMMING
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER { LF, RB, RB, RF}
#endif
